...
object Dependencies {
  ...
  object Versions {
    ...
    // Test
    val specs2                        = "4.10.6"
    val testContainersScalaVersion    = "0.39.0" // https://github.com/testcontainers/testcontainers-scala/releases
    val testContainersPostgresVersion = "1.15.2" // https://github.com/testcontainers/testcontainers-java/releases
